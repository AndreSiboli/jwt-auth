...
function sendRecoveryPassword(receiverEmail, endpoint) {
    return __awaiter(this, void 0, void 0, function* () {
        const smtp = nodemailer_1.default.createTransport({
            ...
            secure: true,
            auth: {
                user: session_config_1.default.emailSender,
                pass: session_config_1.default.emailPassword,
            },
        });
        const emailSkeleton = `
<!doctype html>
<html lang="en">
  ...
  `;
        yield smtp.sendMail({
            from: session_config_1.default.emailSender,
            to: receiverEmail,
